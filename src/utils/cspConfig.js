...
export const generateCSPHeader = (environment = "production") => {
  ...
  const cspDirectives = {
    ...
    "object-src": ["'none'"],
    "base-uri": ["'self'"],
    "form-action": ["'self'", "https://api.karmacall.com", "https://dev-api.karmacall.com", "https://buy.stripe.com", "https://fyncom.chargebee.com"],
...
export const getGatsbyCSPConfig = () => {
  ...
  return {
    ...
    options: {
      ...
      directives: {
        "default-src": "'self'",
        "script-src": `'self' 'unsafe-inline' 'unsafe-eval' https://cdn.auth0.com https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://static.hotjar.com https://script.hotjar.com`,
        ...
        "connect-src": `'self' https://api.karmacall.com https://dev-api.karmacall.com https://ipapi.co https://www.google-analytics.com https://www.googletagmanager.com https://static.hotjar.com https://script.hotjar.com https://vc.hotjar.io wss://ws.hotjar.com`,
        "frame-src": `'self' https://www.youtube.com https://buy.stripe.com https://fyncom.chargebee.com https://js.stripe.com`,
        "object-src": "'none'",
        "base-uri": "'self'",
        "form-action": `'self' https://api.karmacall.com https://dev-api.karmacall.com https://buy.stripe.com https://fyncom.chargebee.com`,
