  ...
  <table style={{width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem'}}>
    <thead>
      <tr style={{borderBottom: '2px solid var(--border-color, #e2e8f0)'}}>
        <th style={{padding: '0.75rem', textAlign: 'left', fontWeight: 'bold'}}>Deposit Amount</th>
        <th style={{padding: '0.75rem', textAlign: 'left', fontWeight: 'bold'}}>Cost</th>
        <th style={{padding: '0.75rem', textAlign: 'left', fontWeight: 'bold'}}>Scammer Risk (10M texts)</th>
        <th style={{padding: '0.75rem', textAlign: 'left', fontWeight: 'bold'}}>If 90% Respond</th>
        <th style={{padding: '0.75rem', textAlign: 'left', fontWeight: 'bold'}}>Legitimate User (100 texts)</th>
      </tr>
    </thead>
    <tbody>
      <tr style={{borderBottom: '1px solid var(--border-color, #e2e8f0)'}}>
        <td style={{padding: '0.75rem', fontWeight: 'bold'}}>$0.0001</td>
        <td style={{padding: '0.75rem'}}>1/100th of a penny</td>
        <td style={{padding: '0.75rem'}}>$1,000 at risk</td>
        <td style={{padding: '0.75rem'}}>Loses $100</td>
        <td style={{padding: '0.75rem'}}>$0.01 at risk (refundable)</td>
      </tr>
      <tr style={{borderBottom: '1px solid var(--border-color, #e2e8f0)'}}>
        <td style={{padding: '0.75rem', fontWeight: 'bold'}}>$0.001</td>
        <td style={{padding: '0.75rem'}}>1/10th of a penny</td>
        <td style={{padding: '0.75rem'}}>$10,000 at risk</td>
        <td style={{padding: '0.75rem'}}>Loses $1,000</td>
        <td style={{padding: '0.75rem'}}>$0.10 at risk (refundable)</td>
      </tr>
      <tr>
        <td style={{padding: '0.75rem', fontWeight: 'bold'}}>$0.01</td>
        <td style={{padding: '0.75rem'}}>One penny</td>
        <td style={{padding: '0.75rem'}}>$100,000 at risk</td>
        <td style={{padding: '0.75rem'}}>Loses $10,000</td>
        <td style={{padding: '0.75rem'}}>$1.00 at risk (refundable)</td>
      </tr>
    </tbody>
  </table>
</div>
