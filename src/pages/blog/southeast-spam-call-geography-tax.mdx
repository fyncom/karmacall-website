...
import panel1 from "../../images/blog/robocall-geography-tax-map.png"
import panel2 from "../../images/blog/complaint-paradox.png"
import panel3 from "../../images/blog/perfect-storm-failure.png"
import panel4 from "../../images/blog/3x-difference-harassment.png"
import panel5 from "../../images/blog/protection-not-geographic.png"
...
<div style={{
  ...
  <img 
    src={panel1} 
    alt="Heat map of the United States showing the robocall geography tax with southeastern states highlighted in red" 
    style={{
      maxWidth: "100%",
      height: "auto",
      borderRadius: "8px",
...
<table style={{
  ...
  <thead>
    <tr style={{ borderBottom: "2px solid var(--border-color, #cbd5e1)" }}>
      <th style={{ padding: "0.75rem", textAlign: "left", fontWeight: "600" }}>State</th>
      <th style={{ padding: "0.75rem", textAlign: "right", fontWeight: "600" }}>Annual Calls Per Capita</th>
      <th style={{ padding: "0.75rem", textAlign: "right", fontWeight: "600" }}>FTC Complaint Rank</th>
      <th style={{ padding: "0.75rem", textAlign: "right", fontWeight: "600" }}>Complaints Per 100k</th>
    </tr>
  </thead>
  <tbody>
    <tr style={{ borderBottom: "1px solid var(--border-color, #e2e8f0)" }}>
      <td style={{ padding: "0.75rem", fontWeight: "600" }}>Louisiana</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>339</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>44th</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>449</td>
    </tr>
    <tr style={{ borderBottom: "1px solid var(--border-color, #e2e8f0)" }}>
      <td style={{ padding: "0.75rem", fontWeight: "600" }}>Mississippi</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>209</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>41st</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>469</td>
    </tr>
    <tr style={{ borderBottom: "1px solid var(--border-color, #e2e8f0)" }}>
      <td style={{ padding: "0.75rem", fontWeight: "600" }}>Alabama</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>248</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>34th</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>490</td>
    </tr>
    <tr style={{ borderBottom: "1px solid var(--border-color, #e2e8f0)" }}>
      <td style={{ padding: "0.75rem", fontWeight: "600" }}>Georgia</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>307</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>20th</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>618</td>
    </tr>
    <tr>
      <td style={{ padding: "0.75rem", fontWeight: "600" }}>California</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>123</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>9th</td>
      <td style={{ padding: "0.75rem", textAlign: "right" }}>730</td>
    </tr>
  </tbody>
</table>
...
<div style={{
  ...
  <img 
    src={panel2} 
    alt="Graph showing the complaint paradox: Louisiana has high spam calls but low complaints, while California has lower spam but high complaints" 
    style={{
      maxWidth: "100%",
      height: "auto",
      borderRadius: "8px",
...
<div style={{
  ...
  <img 
    src={panel3} 
    alt="Infographic showing the three main reasons for the robocall crisis: weaker laws, old infrastructure, and demographic targeting" 
    style={{
      maxWidth: "100%",
      height: "auto",
      borderRadius: "8px",
...
<div style={{
  ...
  <img 
    src={panel4} 
    alt="Side-by-side comparison showing Louisiana receives 339 spam calls per year while California receives only 123" 
    style={{
      maxWidth: "100%",
      height: "auto",
      borderRadius: "8px",
...
<div style={{
  ...
  <img 
    src={panel5} 
    alt="KarmaCall shield protecting the entire United States - spam isn't geographic, your protection shouldn't be either" 
    style={{
      maxWidth: "100%",
      height: "auto",
      borderRadius: "8px",
...
<div style={{
  ...
  <img 
    src="../../images/blog/download-solution.png" 
    alt="Download the solution that works everywhere - KarmaCall app available now" 
    style={{
      maxWidth: "100%",
      height: "auto",
      borderRadius: "8px",
