...
const countryCodes = [
  ...
  { name: "Antigua & Barbuda", code: "AG", dialCode: "+1268" },
  ...
  { name: "Cape Verde Islands", code: "CV", dialCode: "+238" },
  ...
  { name: "Cyprus North", code: "CY", dialCode: "+90392" },
  { name: "Cyprus South", code: "CY", dialCode: "+357" },
  { name: "Czech Republic", code: "CZ", dialCode: "+42" },
  { name: "Denmark", code: "DK", dialCode: "+45" },
  { name: "Djibouti", code: "DJ", dialCode: "+253" },
  { name: "Dominica", code: "DM", dialCode: "+1809" },
  ...
  { name: "Georgia", code: "GE", dialCode: "+7880" },
  ...
  { name: "Guam", code: "GU", dialCode: "+671" },
  ...
  { name: "Liechtenstein", code: "LI", dialCode: "+417" },
  ...
  { name: "Myanmar", code: "MN", dialCode: "+95" },
  ...
  { name: "Norfolk Islands", code: "NF", dialCode: "+672" },
  { name: "Northern Marianas", code: "NP", dialCode: "+670" },
  ...
  { name: "Turkmenistan", code: "TM", dialCode: "+7" },
  { name: "Turkmenistan", code: "TM", dialCode: "+993" },
  { name: "Turks & Caicos Islands", code: "TC", dialCode: "+1649" },
  { name: "Tuvalu", code: "TV", dialCode: "+688" },
  { name: "Uganda", code: "UG", dialCode: "+256" },
  { name: "UK", code: "GB", dialCode: "+44" },
  { name: "Ukraine", code: "UA", dialCode: "+380" },
  { name: "United Arab Emirates", code: "AE", dialCode: "+971" },
  { name: "Uruguay", code: "UY", dialCode: "+598" },
  { name: "USA", code: "US", dialCode: "+1" },
  { name: "Uzbekistan", code: "UZ", dialCode: "+7" },
  ...
  { name: "Yemen (North)", code: "YE", dialCode: "+969" },
  { name: "Yemen (South)", code: "YE", dialCode: "+967" },
